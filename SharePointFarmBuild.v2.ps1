...
<# Account Credentials #>
    ...
    $FarmAccount = new-object -typename system.management.automation.pscredential -argumentlist "$1Domain\SP.Farm",$Credentialpassword
	
    # Service Account for SharePoint Setup	
    $SPSetupAccount = new-object -typename system.management.automation.pscredential -argumentlist "$1Domain\SP.Setup",$Credentialpassword

    # Service Account for SharePoint Web/App Pool Management
    $WebPoolManagedAccount = new-object -typename system.management.automation.pscredential -argumentlist "$1Domain\SP.WebPool",$Credentialpassword
   
    # Service Account for SharePoint Service Pool Management
    $ServicePoolManagedAccount = new-object -typename system.management.automation.pscredential -argumentlist "$1Domain\SP.ServicePool",$Credentialpassword
...
#>
        ...
        SPFarm CreateSPFarm
        {
            ...
            CentralAdministrationPort= '22222'
            DependsOn                = "[SPInstall]InstallSharePoint"
        }
